...
class att_chrome(nn.Module):
	def __init__(self,myargs, args = att_chrome_args):
	...
	def forward(self,tss, tts):
		...
		return prediction_m,None

#att_chrome_model = att_chrome(args, att_chrome_args)
